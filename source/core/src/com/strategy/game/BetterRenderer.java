...
public class BetterRenderer extends IsometricTiledMapRenderer {
    ...
    public BetterRenderer(TiledMap map) {
        super(map);
        init();
    }

    public BetterRenderer(TiledMap map, Batch batch) {
        super(map, batch);
        init();
    }

    public BetterRenderer(TiledMap map, float unitScale) {
        super(map, unitScale);
        init();
    }

    public BetterRenderer(TiledMap map, float unitScale, Batch batch) {
